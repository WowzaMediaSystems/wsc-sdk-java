...
public class IndexCustomStreamTargetModelTest {
	IndexCustomStreamTarget modelObject = new IndexCustomStreamTarget();

	@Test
	public void IndexCustomStreamTargetModelTest_setCreatedAt()
	{
	...
	@Test
	public void IndexCustomStreamTargetModelTest_setId()
	{
		modelObject.setId("Id");
		assertEquals(modelObject.getId(),"Id");
	}
	@Test
	public void IndexCustomStreamTargetModelTest_setName()
	{
		modelObject.setName("Name");
		assertEquals(modelObject.getName(),"Name");
	}
	@Test
	public void IndexCustomStreamTargetModelTest_setUpdatedAt()
	{
