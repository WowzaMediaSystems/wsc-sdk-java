...
public class IndexUllStreamTargetModelTest {
	IndexUllStreamTarget modelObject = new IndexUllStreamTarget();

	@Test
	public void IndexUllStreamTargetModelTest_setCreatedAt()
	{
	...
	@Test
	public void IndexUllStreamTargetModelTest_setId()
	{
		modelObject.setId("Id");
		assertEquals(modelObject.getId(),"Id");
	}
	@Test
	public void IndexUllStreamTargetModelTest_setName()
	{
		modelObject.setName("Name");
		assertEquals(modelObject.getName(),"Name");
	}
	@Test
	public void IndexUllStreamTargetModelTest_setUpdatedAt()
	{
