...
public class FrameRateMetricModelTest {
	FrameRateMetric modelObject = new FrameRateMetric();

	@Test
	public void FrameRateMetricModelTest_setStatus()
	{
		modelObject.setStatus("Status");
		assertEquals(modelObject.getStatus(),"Status");
	}
	@Test
	public void FrameRateMetricModelTest_setText()
	{
		modelObject.setText("Text");
		assertEquals(modelObject.getText(),"Text");
	}
	@Test
	public void FrameRateMetricModelTest_setUnits()
	{
		modelObject.setUnits("Units");
		assertEquals(modelObject.getUnits(),"Units");
	}
	@Test
	public void FrameRateMetricModelTest_setValue()
	{
