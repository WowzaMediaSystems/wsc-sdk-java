...
public class IndexAkamaiStreamSourceModelTest {
	IndexAkamaiStreamSource modelObject = new IndexAkamaiStreamSource();

	@Test
	public void IndexAkamaiStreamSourceModelTest_setCreatedAt()
	{
	...
	@Test
	public void IndexAkamaiStreamSourceModelTest_setId()
	{
		modelObject.setId("Id");
		assertEquals(modelObject.getId(),"Id");
	}
	@Test
	public void IndexAkamaiStreamSourceModelTest_setName()
	{
		modelObject.setName("Name");
		assertEquals(modelObject.getName(),"Name");
	}
	@Test
	public void IndexAkamaiStreamSourceModelTest_setUpdatedAt()
	{
