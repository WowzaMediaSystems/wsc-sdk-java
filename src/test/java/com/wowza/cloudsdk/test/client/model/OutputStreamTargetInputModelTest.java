...
public class OutputStreamTargetInputModelTest {
	OutputStreamTargetInput modelObject = new OutputStreamTargetInput();

    @Test
     public void OutputStreamTargetInputModelTest_setOutputStreamTarget()
     {
