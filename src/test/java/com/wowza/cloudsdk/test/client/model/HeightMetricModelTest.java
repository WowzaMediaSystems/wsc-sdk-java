...
public class HeightMetricModelTest {
	HeightMetric modelObject = new HeightMetric();

	@Test
	public void HeightMetricModelTest_setStatus()
	{
		modelObject.setStatus("Status");
		assertEquals(modelObject.getStatus(),"Status");
	}
	@Test
	public void HeightMetricModelTest_setText()
	{
		modelObject.setText("Text");
		assertEquals(modelObject.getText(),"Text");
	}
	@Test
	public void HeightMetricModelTest_setUnits()
	{
		modelObject.setUnits("Units");
		assertEquals(modelObject.getUnits(),"Units");
	}
	@Test
	public void HeightMetricModelTest_setValue()
	{
