...
public class GpuUsageMetricModelTest {
	GpuUsageMetric modelObject = new GpuUsageMetric();

	@Test
	public void GpuUsageMetricModelTest_setStatus()
	{
		modelObject.setStatus("Status");
		assertEquals(modelObject.getStatus(),"Status");
	}
	@Test
	public void GpuUsageMetricModelTest_setText()
	{
		modelObject.setText("Text");
		assertEquals(modelObject.getText(),"Text");
	}
	@Test
	public void GpuUsageMetricModelTest_setUnits()
	{
		modelObject.setUnits("Units");
		assertEquals(modelObject.getUnits(),"Units");
	}
	@Test
	public void GpuUsageMetricModelTest_setValue()
	{
