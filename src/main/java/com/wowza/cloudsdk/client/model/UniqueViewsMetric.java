...
public class UniqueViewsMetric {
  ...
  public UniqueViewsMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public UniqueViewsMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public UniqueViewsMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public UniqueViewsMetric value(Integer value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "1030", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UniqueViewsMetric uniqueViewsMetric = (UniqueViewsMetric) o;
    return Objects.equals(this.status, uniqueViewsMetric.status) &&
        Objects.equals(this.text, uniqueViewsMetric.text) &&
        Objects.equals(this.units, uniqueViewsMetric.units) &&
        Objects.equals(this.value, uniqueViewsMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class UniqueViewsMetric {\n");
