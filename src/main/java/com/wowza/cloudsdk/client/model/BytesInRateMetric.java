...
public class BytesInRateMetric {
  ...
  public BytesInRateMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public BytesInRateMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public BytesInRateMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public BytesInRateMetric value(Float value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "317.3", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BytesInRateMetric bytesInRateMetric = (BytesInRateMetric) o;
    return Objects.equals(this.status, bytesInRateMetric.status) &&
        Objects.equals(this.text, bytesInRateMetric.text) &&
        Objects.equals(this.units, bytesInRateMetric.units) &&
        Objects.equals(this.value, bytesInRateMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class BytesInRateMetric {\n");
