...
public class StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric {
  ...
  public StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "Active", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric streamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric = (StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric) o;
    return Objects.equals(this.status, streamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric.status) &&
        Objects.equals(this.text, streamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric.text) &&
        Objects.equals(this.units, streamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric.units) &&
        Objects.equals(this.value, streamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class StreamTargetStatusOUTPUTIDXSTREAMTARGETIDXMetric {\n");
