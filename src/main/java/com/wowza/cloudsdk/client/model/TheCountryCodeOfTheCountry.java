...
public class TheCountryCodeOfTheCountry {
  @SerializedName("name")
  ...
  public TheCountryCodeOfTheCountry name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "", value = "The name of the country.")
  ...
  public TheCountryCodeOfTheCountry percentageViewers(Integer percentageViewers) {
  ...
  **/
  ...
  public TheCountryCodeOfTheCountry percentageViewingTime(Integer percentageViewingTime) {
  ...
  **/
  ...
  public TheCountryCodeOfTheCountry protocols(UsageViewerDataProtocols protocols) {
  ...
  **/
  ...
  public TheCountryCodeOfTheCountry secondsAvgViewingTime(Integer secondsAvgViewingTime) {
  ...
  **/
  ...
  public TheCountryCodeOfTheCountry secondsTotalViewingTime(Integer secondsTotalViewingTime) {
  ...
  **/
  ...
  public TheCountryCodeOfTheCountry totalUniqueViewers(Integer totalUniqueViewers) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    TheCountryCodeOfTheCountry theCountryCodeOfTheCountry = (TheCountryCodeOfTheCountry) o;
    return Objects.equals(this.name, theCountryCodeOfTheCountry.name) &&
        Objects.equals(this.percentageViewers, theCountryCodeOfTheCountry.percentageViewers) &&
        Objects.equals(this.percentageViewingTime, theCountryCodeOfTheCountry.percentageViewingTime) &&
        Objects.equals(this.protocols, theCountryCodeOfTheCountry.protocols) &&
        Objects.equals(this.secondsAvgViewingTime, theCountryCodeOfTheCountry.secondsAvgViewingTime) &&
        Objects.equals(this.secondsTotalViewingTime, theCountryCodeOfTheCountry.secondsTotalViewingTime) &&
        Objects.equals(this.totalUniqueViewers, theCountryCodeOfTheCountry.totalUniqueViewers);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, percentageViewers, percentageViewingTime, protocols, secondsAvgViewingTime, secondsTotalViewingTime, totalUniqueViewers);
  }
  ...
  public String toString() {
    ...
    sb.append("class TheCountryCodeOfTheCountry {\n");
