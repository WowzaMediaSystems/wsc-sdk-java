...
public class AudioCodecMetric {
  ...
  public AudioCodecMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public AudioCodecMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public AudioCodecMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public AudioCodecMetric value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "aac", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AudioCodecMetric audioCodecMetric = (AudioCodecMetric) o;
    return Objects.equals(this.status, audioCodecMetric.status) &&
        Objects.equals(this.text, audioCodecMetric.text) &&
        Objects.equals(this.units, audioCodecMetric.units) &&
        Objects.equals(this.value, audioCodecMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class AudioCodecMetric {\n");
