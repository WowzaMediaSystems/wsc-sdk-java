...
public class UsageNetworkTranscoder {
   ...
   * @return bytesBilled
  **/
  @ApiModelProperty(example = "", value = "The amount of usage, in bytes, that was billed for the live stream or transcoder during the selected time frame.")
   ...
   * @return bytesUsed
  **/
  @ApiModelProperty(example = "", value = "The amount of content, in bytes, that went through the live stream or transcoder during the selected time frame.")
