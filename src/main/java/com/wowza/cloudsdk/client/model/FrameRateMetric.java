...
public class FrameRateMetric {
  ...
  public FrameRateMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public FrameRateMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public FrameRateMetric units(String units) {
    this.units = units;
    return this;
  }
   ...
   * @return units
  **/
  @ApiModelProperty(example = "FPS", value = "The unit of the returned value, such as <strong>Kbps</strong>, <strong>bps</strong>, <strong>%</strong>, <strong>FPS</strong>, or <strong>GOP</strong>.")
  ...
  public FrameRateMetric value(Integer value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "30", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FrameRateMetric frameRateMetric = (FrameRateMetric) o;
    return Objects.equals(this.status, frameRateMetric.status) &&
        Objects.equals(this.text, frameRateMetric.text) &&
        Objects.equals(this.units, frameRateMetric.units) &&
        Objects.equals(this.value, frameRateMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class FrameRateMetric {\n");
