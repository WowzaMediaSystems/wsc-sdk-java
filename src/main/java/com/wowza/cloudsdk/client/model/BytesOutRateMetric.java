...
public class BytesOutRateMetric {
  ...
  public BytesOutRateMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public BytesOutRateMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public BytesOutRateMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public BytesOutRateMetric value(Float value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "856.0", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    BytesOutRateMetric bytesOutRateMetric = (BytesOutRateMetric) o;
    return Objects.equals(this.status, bytesOutRateMetric.status) &&
        Objects.equals(this.text, bytesOutRateMetric.text) &&
        Objects.equals(this.units, bytesOutRateMetric.units) &&
        Objects.equals(this.value, bytesOutRateMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class BytesOutRateMetric {\n");
