...
public class KeyframeIntervalMetric {
  ...
  public KeyframeIntervalMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public KeyframeIntervalMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public KeyframeIntervalMetric units(String units) {
    this.units = units;
    return this;
  }
   ...
   * @return units
  **/
  @ApiModelProperty(example = "GOP", value = "The unit of the returned value, such as <strong>Kbps</strong>, <strong>bps</strong>, <strong>%</strong>, <strong>FPS</strong>, or <strong>GOP</strong>.")
  ...
  public KeyframeIntervalMetric value(Integer value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "69", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    KeyframeIntervalMetric keyframeIntervalMetric = (KeyframeIntervalMetric) o;
    return Objects.equals(this.status, keyframeIntervalMetric.status) &&
        Objects.equals(this.text, keyframeIntervalMetric.text) &&
        Objects.equals(this.units, keyframeIntervalMetric.units) &&
        Objects.equals(this.value, keyframeIntervalMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class KeyframeIntervalMetric {\n");
