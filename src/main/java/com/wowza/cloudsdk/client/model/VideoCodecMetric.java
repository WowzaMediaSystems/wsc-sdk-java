...
public class VideoCodecMetric {
  ...
  public VideoCodecMetric status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public VideoCodecMetric text(String text) {
    this.text = text;
    return this;
  }
  ...
  **/
  ...
  public VideoCodecMetric units(String units) {
    this.units = units;
    return this;
  }
  ...
  **/
  ...
  public VideoCodecMetric value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @ApiModelProperty(example = "avc1", value = "The value of the associated key.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VideoCodecMetric videoCodecMetric = (VideoCodecMetric) o;
    return Objects.equals(this.status, videoCodecMetric.status) &&
        Objects.equals(this.text, videoCodecMetric.text) &&
        Objects.equals(this.units, videoCodecMetric.units) &&
        Objects.equals(this.value, videoCodecMetric.value);
  }
  ...
  public String toString() {
    ...
    sb.append("class VideoCodecMetric {\n");
