...
public class FrameSizeMetric {
  ...
  **/
   ...
   * @return text
  **/
  @ApiModelProperty(example = "Configured frame size is different from what Wowza Streaming Cloud is receiving from the source: 1280x720.", value = "A message related to the value and status of the current key. Usually blank unless there's a warning status.")
  ...
  **/
   ...
   * @return value
  **/
  @ApiModelProperty(example = "1280x720", value = "The value of the associated key.")
