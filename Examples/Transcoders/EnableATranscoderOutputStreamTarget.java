...
public class EnableATranscoderOutputStreamTarget {
	...
	try {
		StreamTargetState result = apiInstance.enableTranscoderOutputStreamTarget(transcoderId,outputId,streamTargetId);
		System.out.println(result);
		} catch (ApiException e) {
	    System.err.println("Exception when calling TranscodersApi#enableTranscoderOutputStreamTarget");
